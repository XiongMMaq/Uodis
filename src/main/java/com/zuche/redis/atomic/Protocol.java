...
public final class Protocol {
    ...
    private static void sendCommand(final RedisOutputStream os, final byte[] command,
        ...
        try {
            ...
            throw new FrameworkRedisConnectionException(e);
        }
    }

    private static void processError(final RedisInputStream is) {
        String message = is.readLine();
        throw new FrameworkRedisDataException(message);
    }
...
//  }
    ...
    private static Object process(final RedisInputStream is) {
        ...
        if (b == PLUS_BYTE) {
            ...
            throw new FrameworkRedisConnectionException("Unknown reply: " + (char) b);
        }
    }
    ...
    private static byte[] processBulkReply(final RedisInputStream is) {
        ...
        while (offset < len) {
            ...
            if (size == -1) throw new FrameworkRedisConnectionException(
