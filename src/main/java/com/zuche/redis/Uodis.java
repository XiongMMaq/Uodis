...
//  protected JedisPoolAbstract dataSource = null;
  ...
  public Uodis(final String host) {
    super(host);
  }

  public Uodis(final HostAndPort hp) {
    super(hp);
  }

  public Uodis(final String host, final int port) {
    super(host, port);
  }

  public Uodis(final String host, final int port, final boolean ssl) {
    super(host, port, ssl);
  }
  ...
  public Uodis(final String host, final int port, final int timeout) {
    super(host, port, timeout);
  }

  public Uodis(final String host, final int port, final int timeout, final boolean ssl) {
  ...
  public Uodis(final String host, final int port, final int connectionTimeout, final int soTimeout) {
...
//  public Uodis(JedisShardInfo shardInfo) {
//    super(shardInfo);
//  }

  public Uodis(URI uri) {
    super(uri);
  }

  public Uodis(URI uri, final SSLSocketFactory sslSocketFactory, final SSLParameters sslParameters,
               final HostnameVerifier hostnameVerifier) {
    super(uri, sslSocketFactory, sslParameters, hostnameVerifier);
  }

  public Uodis(final URI uri, final int timeout) {
    super(uri, timeout);
  }

  public Uodis(final URI uri, final int timeout, final SSLSocketFactory sslSocketFactory,
               final SSLParameters sslParameters, final HostnameVerifier hostnameVerifier) {
    super(uri, timeout, sslSocketFactory, sslParameters, hostnameVerifier);
  }

  public Uodis(final URI uri, final int connectionTimeout, final int soTimeout) {
  ...
  @Override
  public void subscribe(final UodisPubSub uodisPubSub, final String... channels) {
    client.setTimeoutInfinite();
    try {
      uodisPubSub.proceed(client, channels);
    } finally {
      client.rollbackTimeout();
    }
  }
  ...
  @Override
  public void psubscribe(final UodisPubSub uodisPubSub, final String... patterns) {
    checkIsInMultiOrPipeline();
    client.setTimeoutInfinite();
    try {
      uodisPubSub.proceedWithPatterns(client, patterns);
    } finally {
      client.rollbackTimeout();
    }
  }
