...
import com.zuche.redis.support.Builder;
import com.zuche.redis.support.MultiKeyPipelineBase;
import com.zuche.redis.support.Response;
...
public class Pipeline extends MultiKeyPipelineBase implements Closeable {
  ...
  private class MultiResponseBuilder extends Builder<List<Object>> {
    ...
    public List<Object> build(Object data) {
      ...
      if (list.size() != responses.size()) {
        throw new FrameworkRedisDataException("Expected data size " + responses.size() + " but was "
            + list.size());
      }
  ...
  public Response<String> discard() {
    if (currentMulti == null) throw new FrameworkRedisDataException("DISCARD without MULTI");
    client.discard();
    currentMulti = null;
  ...
  public Response<List<Object>> exec() {
    if (currentMulti == null) throw new FrameworkRedisDataException("EXEC without MULTI");
  ...
  public Response<String> multi() {
    if (currentMulti != null) throw new FrameworkRedisDataException("MULTI calls can not be nested");
